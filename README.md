...
```bash
bash <(wget -qO- 'https://elppans.github.io/archlinux-meta/gnome-shell-meta.sh')
```
...
Este repositório foi **desenvolvido para uso pessoal**, mas contribuições são bem-vindas! Caso você tenha sugestões, melhorias ou encontre problemas, sinta-se à vontade para abrir uma [*issue*](https://github.com/elppans/archlinux-meta/issues) ou enviar um *pull request*.
